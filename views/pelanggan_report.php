        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class=""></span> Laporan Pelanggan</h3>
                </div>
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                        <tr>
                                <th>No.</th><th class="text-center">Nama</th><th class="text-center">Alamat</th><th class="text-center">Jenis Kelamin</th><th class="text-center">Tanggal Beli</th><th>ACTIONS</th>
                            </tr> 
                        </thead>
                        <tbody>
