        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class=""></span> Laporan Obat</h3>
                </div>
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                        <tr>
                                <th>No.</th><th class="text-center">Nama Obat</th><th class="text-center">Pembuat Obat</th><th class="text-center">Stok</th><th class="text-center">Kadaluarsa</th><th>ACTIONS</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <td><?= $nomor ?></td>
                                    ...
                                    <td>
                                        <a href="report/obat_satu.php?id=<?= $data['id_obat'] ?>" target="_blank" class="btn btn-info btn-xs">
